...
function ArticleContents(props){
    const {article_id, title, author, image, body, created_at, votes} = props
    ...
    return (<>
        ...
        <button onClick={handleClick} disabled={signedInUser ? false : true}>{signedInUser ? (votedForArticle ? "Remove vote" : "Vote for this article") : "Sign in to vote"}</button>
