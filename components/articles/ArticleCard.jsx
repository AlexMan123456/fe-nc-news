...
function ArticleCard(props){
    ...
    return (<fieldset key={`article-${article_id}-card`} className="article-card">
        <img 
        ...
        <div id="article-stat-counts">
            <label className="article-stat-count" key={`article-${article_id}-votes`}>Votes: {votes}</label>
            <label className="article-stat-count" key={`article-${article_id}-comment-count`}>Comments: {comment_count}</label>
        </div>
    </fieldset>)
}
